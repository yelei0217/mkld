...
public abstract class AbstractClaimAccountEditUI extends com.kingdee.eas.framework.client.EditUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {chkisCalim,chkisSendDms,txtbusDivision,dataState}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 423, 209));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(45, 15, 328, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(45, 41, 328, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(45, 67, 328, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(45, 93, 328, 19));
        this.add(kDLabelContainer4, null);
        chkisCalim.setBounds(new Rectangle(251, 148, 118, 19));
        this.add(chkisCalim, null);
        chkisSendDms.setBounds(new Rectangle(45, 148, 110, 19));
        this.add(chkisSendDms, null);
        contbusDivision.setBounds(new Rectangle(45, 119, 328, 19));
        this.add(contbusDivision, null);
        contdataState.setBounds(new Rectangle(45, 173, 328, 19));
