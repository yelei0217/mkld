 ...
 * output class name
 */
public abstract class AbstractReceiptSentRecordEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractReceiptSentRecordEditUI.class);
     ...
     */
    public AbstractReceiptSentRecordEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractReceiptSentRecordEditUI.class.getName());
        ...
        this.contsourceType.setBoundLabelLength(100);		
        this.contsourceType.setBoundLabelUnderline(true);		
        this.contsourceType.setVisible(true);
        // contSentFlag		
        ...
        // txtDescription
        // sourceType		
        this.sourceType.setVisible(true);		
        this.sourceType.addItems(EnumUtils.getEnumList("com.kingdee.eas.mkld.sapinterage.app.ReceiptSourceTypeMenu").toArray());		
        this.sourceType.setRequired(false);
        // SentFlag		
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mkld.sapinterage.app.ReceiptSentRecordEditUIHandler";
	}
    ...
    {
        super.onShow();
        this.sourceType.requestFocusInWindow();
    }
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.mkld.sapinterage.ReceiptSentRecordInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mkld.sapinterage.client", "ReceiptSentRecordEditUI");
    }
