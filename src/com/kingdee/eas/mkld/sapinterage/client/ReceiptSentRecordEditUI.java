 ...
 * output class name
 */
public class ReceiptSentRecordEditUI extends AbstractReceiptSentRecordEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ReceiptSentRecordEditUI.class);
    
    /**
     * output class constructor
     */
    public ReceiptSentRecordEditUI() throws Exception
    {
        super();
    }
    /**
