 ...
 * output class name
 */
public abstract class AbstractSAPInterfaceLogListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSAPInterfaceLogListUI.class);
     ...
     */
    public AbstractSAPInterfaceLogListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSAPInterfaceLogListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.mkld.sapinterage.app", "SAPInterfaceLogQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mkld.sapinterage.app.SAPInterfaceLogListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("InterType"));
        sic.add(new SelectorItemInfo("ClaimType"));
        sic.add(new SelectorItemInfo("InterResult"));
        sic.add(new SelectorItemInfo("reqTime"));
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractSAPInterfaceLogListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSAPInterfaceLogListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mkld.sapinterage.client", "SAPInterfaceLogListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.mkld.sapinterage.client.SAPInterfaceLogEditUI.class.getName();
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","InterType","ClaimType","InterResult","reqTime","request","respond"};
    }



	protected String getTDFileName() {
    	return "/bim/mkld/sapinterage/SAPInterfaceLog";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.mkld.sapinterage.app.SAPInterfaceLogQuery");
	}
