 ...
 * output class name
 */
public abstract class AbstractReceiptSentRecordListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractReceiptSentRecordListUI.class);
    /**
     * output class constructor
     */
    public AbstractReceiptSentRecordListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.mkld.sapinterage.app.ReceiptSentRecordListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.mkld.sapinterage.client", "ReceiptSentRecordListUI");
    }
    ...
    {
        return com.kingdee.eas.mkld.sapinterage.client.ReceiptSentRecordEditUI.class.getName();
    }
