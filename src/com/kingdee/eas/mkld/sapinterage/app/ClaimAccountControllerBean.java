...
public class ClaimAccountControllerBean extends AbstractClaimAccountControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.mkld.sapinterage.app.ClaimAccountControllerBean");
}